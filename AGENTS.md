...
🔴 **제출** https://matdaaiga.kr/matdathon/issues — 템플릿 `03-result-submission` (`01-github-handle` / `02-team-building` / `03-result-submission`).
필수 입력: 앱 제목 · **공개 레포 URL** · **커밋 해시** · **배포 URL** · (선택)앱 설명.
**마감 16:30. 초과 = 자동 탈락.** 제출 최대 2회, 마지막 것으로 평가 → 중간에 1차 내고 마감 전 갱신하라.
